...
<div class="modal fade" id="requestForm" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  ...
  <div class="md-form form-group mt-5" >
    <input type="date" class="form-control" id="formGroupExampleInputMD" placeholder="Example input" >
    <label for="formGroupExampleInputMD" style="font-size:12px;margin-top:-5%">Date</label>
  </div>
  <!-- Material input -->
  <div class="md-form form-group mt-5">
    <input type="time" class="form-control" id="formGroupExampleInput2MD" placeholder="Another input">
  ...
  <div class="md-form form-group mt-5" style="padding-top:5%" >
    <input type="text" class="form-control" id="formGroupExampleInput2MD" placeholder="Duration of Service">
    <label for="formGroupExampleInput2MD" style="font-size:12px;margin-top:3%">Duration</label>
  </div>
  <div class="md-form form-group mt-5" style="padding-top:5%" >
    <input type="text" class="form-control" id="formGroupExampleInput2MD" placeholder="*Optional*">
